          ...
          <div className="p-4 md:p-8 flex-1 flex flex-col gap-6">
            ...
            {isEditable && (
              <div className="bg-bauhaus-white border-4 border-bauhaus-black p-4 md:p-6">
                 <label className="block text-sm font-bold uppercase mb-2">ボイス設定 (2名)</label>
                 
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <span className="text-xs font-bold text-gray-500 block mb-1">Host (メイン進行)</span>
                    ...
                    <div>
                        <span className="text-xs font-bold text-gray-500 block mb-1">Expert (解説役)</span>
                        <div className="relative">
                            <select
                 ...
                 <p className="mt-2 text-xs text-gray-500 font-bold uppercase">プロンプトのペルソナに最適なボイスの組み合わせを選択してください。</p>
              </div>
            )}
